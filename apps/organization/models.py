...
class Member(TimeStampedModel):
    ...
    address = models.TextField()
    body_height = models.CharField(max_length=25, null=True, blank=True)
    body_weight = models.CharField(max_length=25, null=True, blank=True)
    draw_length = models.IntegerField(default=0, null=True, blank=True)
